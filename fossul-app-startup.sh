...
if [[ -z "${FOSSUL_APP_SERVICE_PORT}" ]]; then
    export FOSSUL_APP_SERVICE_PORT=$PORT
fi    

if [[ -z "${FOSSUL_APP_PLUGIN_DIR}" ]]; then
    export FOSSUL_APP_PLUGIN_DIR=$PLUGIN_DIR
fi    
...
if [[ -z "${FOSSUL_APP_DEBUG}" ]]; then
    export FOSSUL_APP_DEBUG=$DEBUG
fi    
